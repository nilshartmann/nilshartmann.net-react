...
const connectedComponent = connectModel(FullPostPage, ({ post, loadPostError }) => ({ post, loadPostError }), ({ loadPost, isLoggedIn, editPost, publishPost }) => ({ loadPost, loggedIn: isLoggedIn(), editPost, publishPost }));
